...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/customer/activity/list.js"></script>
<div class="page-header">
	...
	<shiro:hasPermission name="activity:deleteBatch ">
	...
	<div class="col-xs-12 widget-container-col ui-sortable"
		...
		<div class="widget-box transparent ui-sortable-handle"
			...
			<div class="widget-header">
				<h4 class="widget-title lighter">活动列表</h4>
