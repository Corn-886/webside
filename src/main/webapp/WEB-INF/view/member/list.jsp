...
<div class="page-header">
	...
	<button id="btnAdd" type="button" onclick="webside.common.addModel('/member/addUI.html')" class="btn btn-primary btn-sm">
	...
	<shiro:hasPermission name="member:deleteBatch ">
	<button id="btnDel" type="button" onclick="" class="btn btn-danger btn-sm">
		<i class="fa fa-trash-o"></i>&nbsp;删除
	</button>
	</shiro:hasPermission>
	<shiro:hasPermission name="member:excuteBatch">
	<button id="btnDel" type="button" onclick="" class="btn btn-warning btn-sm">
		<i class="fa fa-unlock-alt"></i>&nbsp;批量导入
	</button>
	</shiro:hasPermission>
</div>
